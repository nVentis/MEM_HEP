...
export MARLIN_DLL=$MARLIN_DLL:$PWD/source/ZHHPostRecoMEProcessor/lib/ZHHPostRecoMEProcessor.so:$PWD/source/CompareTrueMEProcessor/lib/CompareTrueMEProcessor.so
