...
export MARLIN_DLL=$MARLIN_DLL:$PWD/source/ZHHPostRecoMEProcessor/lib/libZHHPostRecoMEProcessor.so:$PWD/source/CompareTrueMEProcessor/lib/CompareTrueMEProcessor.so
