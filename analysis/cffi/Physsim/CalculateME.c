...
{
  return calc_zhh_single(x0);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_calc_zhh_single(PyObject *self, PyObject *arg0)
{
  double * x0;
  Py_ssize_t datasize;
...
#else
#  define _cffi_f_calc_zhh_single _cffi_d_calc_zhh_single
#endif

static double _cffi_d_calc_zzh_single(double * x0)
{
  return calc_zzh_single(x0);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_calc_zzh_single(PyObject *self, PyObject *arg0)
{
  double * x0;
  Py_ssize_t datasize;
  struct _cffi_freeme_s *large_args_free = NULL;
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_CalculateME(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_CalculateME(void) { return NULL; }
#  else
     initCalculateME(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_CalculateME(void)
{
  return _cffi_init("CalculateME", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initCalculateME(void)
{
  _cffi_init("CalculateME", 0x2601, &_cffi_type_context);
}
#endif
