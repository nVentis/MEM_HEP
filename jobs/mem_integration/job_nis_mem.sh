...
python /afs/desy.de/user/b/bliewert/public/MarlinWorkdirs/MEM_HEP/cli mem integrate $event ./result.txt --me_type=1 --sampling=nis --with_perms=0 --job=${job} --same_size=1